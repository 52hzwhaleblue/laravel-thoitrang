                            ...
                            <tr>
                                ...
                                <th class="align-middle">
                                    <a
                                        class="d-block"
                                        href=" {{
                                            route('admin.product.product-cat.edit', 2)
                                        }} "
                                    >
                                        <img
                                ...
                                <th class="align-middle">
                                    <a href=" {{route('admin.product.product-cat.edit', 2)}} " class="btn btn-primary mr-2">
                                        Sửa
                                    </a>

                                    <a href=" {{route('admin.product.product-cat.destroy',2)}} " class="btn btn-danger"> xóa </a>
                                </th>
                            </tr>
                        </tbody>
                    </table>
