...
<!-- OwlCarousel -->
<link rel="stylesheet" href="{{ asset('public/assets/js/OwlCarousel2-2.3.4/dist/assets/owl.carousel.css') }}">
<link rel="stylesheet"
    href="{{ asset('public/assets/js/OwlCarousel2-2.3.4/dist/assets/owl.theme.default.css') }}">

<!-- Slick -->
<link rel="stylesheet" type="text/css" href="{{ asset('public/assets/slick1.8.1/slick.css') }}"/>
<link rel="stylesheet" type="text/css" href="{{ asset('public/assets/slick1.8.1/slick-theme.css') }}"/>
