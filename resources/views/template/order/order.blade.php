				    ...
				    <div class="section-cart">
				    	...
				    	<div class="information-cart">
				            ...
				            <div class="input-cart">
				                <input type="email" class="form-control text-sm" id="email" name="dataOrder[email]" placeholder="Email" value="<?=(!empty($flash->has('email'))) ? $flash->get('email') : ''?>" />
				                <?php /* <div class="invalid-feedback"><?=vuilongnhapdiachiemail?></div> */?>
				            </div>
				            <div class="form-row">
