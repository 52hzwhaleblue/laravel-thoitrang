...
class PostSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $tintuc1 = [
            ...
            "photo" => "thumbnails/post/tintuc1.jpg",
            "status" => 1,
            "type"=>"tin-tuc",
            "created_at" => $current,
            "updated_at" => $current,
        ...
        $tintuc2 = [
            ...
            "photo" => "thumbnails/post/tintuc2.jpg",
            "status" => 1,
            "type"=>"tin-tuc",
            "created_at" => $current,
            "updated_at" => $current,
        ...
        $tintuc3 = [
            ...
            "photo" => "thumbnails/post/tintuc3.jpg",
            "status" => 1,
            "type"=>"tin-tuc",
            "created_at" => $current,
            "updated_at" => $current,
        ...
        $dichvu1 = [
            ...
            "desc" =>"",
            "photo" => "thumbnails/post/dichvu1.jpg",
            "status" => 1,
            "type"=>"dich-vu",
            "created_at" => $current,
            "updated_at" => $current,
        ...
        $dichvu2 = [
            ...
            "desc" =>"",
            "photo" => "thumbnails/post/dichvu2.jpg",
            "status" => 1,
            "type"=>"dich-vu",
            "created_at" => $current,
            "updated_at" => $current,
